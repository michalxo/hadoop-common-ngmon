...
public class ResourceMgrDelegate extends YarnClient {
  private static final /* LogLOG=LogFactory.getLog(ResourceMgrDelegate.class); */
  ...
  public TaskTrackerInfo[] getBlacklistedTrackers() throws IOException,
    ...
    LOG.getblacklistedtrackers_not_implemented_y().warn();
...
//    Path path = new Path(MRJobConstants.JOB_SUBMIT_DIR);
    ...
    LOG.getstagingareadir_dir(path.toString()).debug();
