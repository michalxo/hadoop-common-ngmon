...
public class YARNRunner implements ClientProtocol {
  ...
  private static final /* LogLOG=LogFactory.getLog(YARNRunner.class); */
  ...
  public ApplicationSubmissionContext createApplicationSubmissionContext(
    ...
    LOG.appmaster_capability(capability.toString()).debug();
    ...
    LOG.creating_setup_context_jobsubmitdir_url(yarnUrlForJobSubmitDir.toString()).debug();
    ...
    LOG.command_launch_container_for_application(mergedCommand.toString()).debug();
  ...
  public void killJob(JobID arg0) throws IOException, InterruptedException {
    ...
    try {
      ...
      LOG.error_when_checking_for_application_stat(io.toString()).debug();
    }
  ...
  private static void warnForJavaLibPath(String opts, String component, 
    ...
    if (opts != null && opts.contains("-Djava.library.path")) {
      ...
      LOG.usage_djava_library_path_can_cause_progr(javaConf, component, envConf).warn();
    }
  }
}
