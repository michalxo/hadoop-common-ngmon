...
public class JobHistoryCopyService extends CompositeService implements HistoryEventHandler {
  ...
  private static final /* LogLOG=LogFactory.getLog(JobHistoryCopyService.class); */
  ...
  private void parse() throws IOException {
    ...
    try {
      ...
      LOG.error_trying_open_previous_history_file_(e.toString()).warn();
      return;
    }
  ...
  public static FSDataInputStream getPreviousJobHistoryFileStream(
    ...
    LOG.history_file(historyFile.toString()).info();
