...
public class MRClientService extends AbstractService implements ClientService {
  ...
  static final /* LogLOG=LogFactory.getLog(MRClientService.class); */
  ...
  protected void serviceStart() throws Exception {
    ...
    LOG.instantiated_mrclientservice(String.valueOf(this.bindAddress)).tag("methodCall").info();
    try {
      ...
      LOG.webapps_failed_start_ignoring_for_now(e.toString()).error();
    }
    super.serviceStart();
  }
  ...
  class MRClientProtocolHandler implements MRClientProtocol {
    ...
    public GetTaskReportsResponse getTaskReports(
      ...
      LOG.getting_task_report_for_report_size(taskType.toString(), jobId.toString(), String.valueOf(tasks.size())).tag("methodCall").info();
