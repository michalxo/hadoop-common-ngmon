...
public class ContainerLauncherImpl extends AbstractService implements
  ...
  private class Container {
    ...
    public synchronized void launch(ContainerRemoteLaunchEvent event) {
      ...
      LOG.launching(taskAttemptID.toString()).info();
      ...
      try {
        ...
        LOG.shuffle_port_returned_containermanager_f(taskAttemptID.toString(), port).info();
    ...
    public synchronized void kill() {
      ...
      if(this.state == ContainerState.PREP) {
        ...
        LOG.killing(taskAttemptID.toString()).info();
  ...
  protected void serviceInit(Configuration conf) throws Exception {
    ...
    LOG.upper_limit_thread_pool_size(String.valueOf(this.limitOnPoolSize)).tag("methodCall").info();
        ...
        while (!stopped.get() && !Thread.currentThread().isInterrupted()) {
          ...
          if (poolSize != limitOnPoolSize) {
            ...
            if (poolSize < idealPoolSize) {
              ...
              LOG.setting_containerlauncher_pool_size_numb(newPoolSize, numNodes).info();
