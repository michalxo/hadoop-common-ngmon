...
public class JobSplitWriter {
  ...
  private static final /* LogLOG=LogFactory.getLog(JobSplitWriter.class); */
    ...
    if (array.length != 0) {
      ...
      for(T split: array) {
        ...
        if (locations.length > maxBlockLocations) {
          ...
          LOG.max_block_location_exceeded_for_split_sp(split.toString(), String.valueOf(locations.length), maxBlockLocations).tag("methodCall").warn();
