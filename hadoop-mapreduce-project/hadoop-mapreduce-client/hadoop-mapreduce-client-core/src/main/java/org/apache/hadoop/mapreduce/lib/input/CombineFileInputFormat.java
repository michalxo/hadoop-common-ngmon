...
public abstract class CombineFileInputFormat<K, V>
  ...
  private static final /* LogLOG=LogFactory.getLog(CombineFileInputFormat.class); */
  ...
  void createSplits(Map<String, Set<OneBlockInfo>> nodeToBlocks,
    ...
    while(true) {
      ...
      if (completedNodes.size() == totalNodes || totalLength == 0) {
        ...
        LOG.debug_terminated_node_allocation_with_co(String.valueOf(completedNodes.size()), totalLength).tag("methodCall").info();
        break;
      }
    }
