...
public class FieldSelectionMapper<K, V>
  ...
  public static final /* LogLOG=LogFactory.getLog("FieldSelectionMapReduce"); */
  ...
  public void setup(Context context) 
    ...
    LOG.nignoreinputkey(String.valueOf(FieldSelectionHelper.specToString(fieldSeparator,mapOutputKeyValueSpec,allMapValueFieldsFrom,mapOutputKeyFieldList,mapOutputValueFieldList)), ignoreInputKey).tag("methodCall").info();
  }
