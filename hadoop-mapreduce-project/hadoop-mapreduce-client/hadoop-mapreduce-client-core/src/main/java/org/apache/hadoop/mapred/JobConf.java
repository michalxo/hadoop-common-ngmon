...
public class JobConf extends Configuration {
  ...
  private static final /* LogLOG=LogFactory.getLog(JobConf.class); */
  ...
  public long getMaxVirtualMemoryForTask() {
    ...
    LOG.getmaxvirtualmemoryfortask_deprecated_in().warn();
  ...
  public void setMaxVirtualMemoryForTask(long vmem) {
    ...
    LOG.setmaxvirtualmemoryfortask_deprecated_in().warn();
  ...
  public long getMaxPhysicalMemoryForTask() {
    ...
    LOG.api_getmaxphysicalmemoryfortask_deprecat().warn();
    return -1;
  }
  ...
  public void setMaxPhysicalMemoryForTask(long mem) {
    ...
    LOG.api_setmaxphysicalmemoryfortask_deprecat().warn();
  }
  ...
  private void checkAndWarnDeprecation() {
    if(get(JobConf.MAPRED_TASK_MAXVMEM_PROPERTY) != null) {
      ...
      LOG.instead_use_and(String.valueOf(JobConf.deprecatedString(JobConf.MAPRED_TASK_MAXVMEM_PROPERTY)), String.valueOf(JobConf.MAPREDUCE_JOB_MAP_MEMORY_MB_PROPERTY), String.valueOf(JobConf.MAPREDUCE_JOB_REDUCE_MEMORY_MB_PROPERTY)).tag("methodCall").warn();
    }
    if(get(JobConf.MAPRED_TASK_ULIMIT) != null ) {
      /* LOG.warn(JobConf.deprecatedString(JobConf.MAPRED_TASK_ULIMIT)) */
      LOG.jobconfdeprecate(String.valueOf(JobConf.deprecatedString(JobConf.MAPRED_TASK_ULIMIT))).tag("methodCall").warn();
    }
    if(get(JobConf.MAPRED_MAP_TASK_ULIMIT) != null ) {
      /* LOG.warn(JobConf.deprecatedString(JobConf.MAPRED_MAP_TASK_ULIMIT)) */
      LOG.jobconfdeprecate(String.valueOf(JobConf.deprecatedString(JobConf.MAPRED_MAP_TASK_ULIMIT))).tag("methodCall").warn();
    }
    if(get(JobConf.MAPRED_REDUCE_TASK_ULIMIT) != null ) {
      /* LOG.warn(JobConf.deprecatedString(JobConf.MAPRED_REDUCE_TASK_ULIMIT)) */
      LOG.jobconfdeprecate(String.valueOf(JobConf.deprecatedString(JobConf.MAPRED_REDUCE_TASK_ULIMIT))).tag("methodCall").warn();
    }
  }
