...
public class MultithreadedMapRunner<K1, V1, K2, V2>
  ...
  private static final /* LogLOG=LogFactory.getLog(MultithreadedMapRunner.class.getName()); */
  ...
  public void configure(JobConf jobConf) {
    ...
    if (LogGlobal.isDebugEnabled()) {
      ...
      LOG.configuring_jobconf_use_threads(String.valueOf(jobConf.getJobName()), numberOfThreads).tag("methodCall").debug();
    }
  ...
  public void run(RecordReader<K1, V1> input, OutputCollector<K2, V2> output,
    ...
    try {
      ...
      if (LogGlobal.isDebugEnabled()) {
        ...
        LOG.finished_dispatching_all_mappper_map_cal(String.valueOf(job.getJobName())).tag("methodCall").debug();
      }
      ...
      try {
        ...
        while (!executorService.awaitTermination(100, TimeUnit.MILLISECONDS)) {
          if (LogGlobal.isDebugEnabled()) {
            ...
            LOG.awaiting_all_running_mappper_map_calls(String.valueOf(job.getJobName())).tag("methodCall").debug();
          }
