...
public class FloatSplitter implements DBSplitter {
  ...
  private static final /* LogLOG=LogFactory.getLog(FloatSplitter.class); */
  ...
  public List<InputSplit> split(Configuration conf, ResultSet results, String colName)
    ...
    LOG.generating_splits_for_floating_point_ind().warn();
    /* LOG.warn("imprecise representation of floating-point values in Java, this") */
    LOG.imprecise_representation_floating_point_().warn();
    /* LOG.warn("may result in an incomplete import.") */
    LOG.may_result_incomplete_import().warn();
    /* LOG.warn("You are strongly encouraged to choose an integral split column.") */
    LOG.you_are_strongly_encouraged_choose_integ().warn();
