...
public class FieldSelectionReducer<K, V>
  ...
  public void setup(Context context) 
    ...
    LOG.fieldselectionhe(String.valueOf(FieldSelectionHelper.specToString(fieldSeparator,reduceOutputKeyValueSpec,allReduceValueFieldsFrom,reduceOutputKeyFieldList,reduceOutputValueFieldList))).tag("methodCall").info();
  }
