...
public class OracleDBRecordReader<T extends DBWritable> extends DBRecordReader<T> {
  ...
  private static final /* LogLOG=LogFactory.getLog(OracleDBRecordReader.class); */
  ...
  public static void setSessionTimeZone(Configuration conf,
    ...
    try {
      ...
      LOG.could_not_find_method_setsessiontimezone(String.valueOf(conn.getClass().getName()), ex.toString()).tag("methodCall").error();
