...
public class PartialFileOutputCommitter
  ...
  private static final /* LogLOG=LogFactory.getLog(PartialFileOutputCommitter.class); */
  ...
  public void cleanUpPartialOutputForTask(TaskAttemptContext context)
    ...
    LOG.cleanuppartialoutputfortask_removing_eve(String.valueOf(context.getTaskAttemptID().getTaskID()), getCommittedTaskPath(context).getParent().toString()).tag("methodCall").info();
