...
class InMemoryMapOutput<K, V> extends MapOutput<K, V> {
  private static final /* LogLOG=LogFactory.getLog(InMemoryMapOutput.class); */
  ...
  public void shuffle(MapHost host, InputStream input,
    ...
    try {
      ...
      LOG.read_bytes_from_map_output_for(String.valueOf(memory.length), getMapId().toString()).tag("methodCall").info();
