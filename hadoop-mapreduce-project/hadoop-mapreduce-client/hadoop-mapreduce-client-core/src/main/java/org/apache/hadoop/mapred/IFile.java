...
public class IFile {
  private static final /* LogLOG=LogFactory.getLog(IFile.class); */
    ...
    public Writer(Configuration conf, FSDataOutputStream out, 
      ...
      if (codec != null) {
        ...
        if (this.compressor != null) {
          ...
          LOG.could_not_obtain_compressor_from_codecpo().warn();
    ...
    public Reader(Configuration conf, FSDataInputStream in, long length, 
      ...
      if (codec != null) {
        ...
        if (decompressor != null) {
          ...
          LOG.could_not_obtain_decompressor_from_codec().warn();
          this.in = checksumIn;
        }
      } else {
        this.in = checksumIn;
