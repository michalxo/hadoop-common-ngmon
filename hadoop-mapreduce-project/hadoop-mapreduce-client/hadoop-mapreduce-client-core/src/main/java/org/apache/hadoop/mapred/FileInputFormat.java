...
public abstract class FileInputFormat<K, V> implements InputFormat<K, V> {
  ...
  public static final /* LogLOG=LogFactory.getLog(FileInputFormat.class); */
  ...
  protected FileStatus[] listStatus(JobConf job) throws IOException {
    ...
    LOG.total_input_paths_process(String.valueOf(result.length)).tag("methodCall").info();
    return result;
  }
  ...
  public InputSplit[] getSplits(JobConf job, int numSplits)
    ...
    if (LogGlobal.isDebugEnabled()) {
      ...
      LOG.total_splits_generated_getsplits_timetak(String.valueOf(splits.size()), String.valueOf(sw.elapsedMillis())).tag("methodCall").debug();
    }
