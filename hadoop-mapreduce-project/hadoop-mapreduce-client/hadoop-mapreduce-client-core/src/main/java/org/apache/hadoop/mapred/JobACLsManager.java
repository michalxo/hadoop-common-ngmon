...
public class JobACLsManager {
  ...
  static final /* LogLOG=LogFactory.getLog(JobACLsManager.class); */
  ...
  public boolean checkAccess(UserGroupInformation callerUGI,
    ...
    if (LogGlobal.isDebugEnabled()) {
      ...
      LOG.checkaccess_job_acls_jobowner_jobacl_use(jobOwner, String.valueOf(jobOperation.toString()), String.valueOf(callerUGI.getShortUserName())).tag("methodCall").debug();
    }
