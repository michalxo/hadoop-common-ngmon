...
public class JobHistoryServer extends CompositeService {
  ...
  private static final /* LogLOG=LogFactory.getLog(JobHistoryServer.class); */
  ...
  private class HistoryServerSecretManagerService
    ...
    protected void serviceStart() throws Exception {
      ...
      try {
        ...
        LOG.error_while_starting_secret_manager_thre(io.toString()).error();
        throw io;
      }
  ...
  static JobHistoryServer launchJobHistoryServer(String[] args) {
    ...
    StringUtils.startupShutdownMessage(JobHistoryServer.class, args, null);
    ...
    try {
      ...
      LOG.error_starting_jobhistoryserver(t.toString()).fatal();
