...
public class HSAuditLogger {
  private static final /* LogLOG=LogFactory.getLog(HSAuditLogger.class); */
  ...
  public static void logSuccess(String user, String operation, String target) {
    if (LogGlobal.isInfoEnabled()) {
      ...
      LOG.createsuccesslog(createSuccessLog(user,operation,target)).tag("methodCall").info();
    }
  }
  ...
  public static void logFailure(String user, String operation, String perm,
    ...
    if (LogGlobal.isWarnEnabled()) {
      ...
      LOG.createfailurelog(createFailureLog(user,operation,perm,target,description)).tag("methodCall").warn();
    }
  }
