...
public class SaslRpcServer {
  public static final /* LogLOG=LogFactory.getLog(SaslRpcServer.class); */
    ...
    switch (authMethod) {
      ...
      case KERBEROS: {
        ...
        if (LogGlobal.isDebugEnabled())
          ...
          LOG.kerberos_principal_name(fullName).debug();
  ...
  public SaslServer create(final Connection connection,
    ...
    if (LogGlobal.isDebugEnabled()) {
      ...
      LOG.created_sasl_server_with_mechanism(mechanism).debug();
    }
    return saslServer;
  }
    ...
    public void handle(Callback[] callbacks) throws InvalidToken,
      ...
      if (pc != null) {
        ...
        if (LogGlobal.isDebugEnabled()) {
          ...
          LOG.sasl_server_digest_callback_setting_pass(String.valueOf(tokenIdentifier.getUser())).tag("methodCall").debug();
        }
      ...
      if (ac != null) {
        ...
        if (ac.isAuthorized()) {
          if (LogGlobal.isDebugEnabled()) {
            ...
            LOG.sasl_server_digest_callback_setting_cano(username).debug();
          }
      ...
      if (ac != null) {
        ...
        if (ac.isAuthorized()) {
          if (LogGlobal.isDebugEnabled())
            ...
            LOG.sasl_server_gssapi_callback_setting_cano(authzid).debug();
          ac.setAuthorizedID(authzid);
        }
      }
    }
