...
public class IOUtils {
  public static final /* LogLOG=LogFactory.getLog(IOUtils.class); */
      ...
      if (c != null) {
        try {
          ...
          if (log != null && log.isDebugEnabled()) {
            LOG.exception_in_closing(c.toString(), e.toString());
          }
        }
      }
    }
  ...
  public static void closeSocket(Socket sock) {
    if (sock != null) {
      try {
        ...
        LOG.ignoring_exception_while_closing_socket(ignored.toString()).debug();
      }
    }
  }
