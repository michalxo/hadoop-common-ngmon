...
public class RetryUtils {
  public static final /* LogLOG=LogFactory.getLog(RetryUtils.class); */
  ...
  public static RetryPolicy getDefaultRetryPolicy(
    ...
    if (LogGlobal.isDebugEnabled()) {
      ...
      LOG.multiplelinearrandomretry(multipleLinearRandomRetry.toString()).debug();
    }
      ...
      return new RetryPolicy() {
        ...
        public RetryAction shouldRetry(Exception e, int retries, int failovers,
          ...
          if (LogGlobal.isDebugEnabled()) {
            ...
            LOG.retry_policy_exception(retries, String.valueOf(p.getClass().getSimpleName()), e.toString()).tag("methodCall").debug();
          }
