...
public class UTF8 implements WritableComparable<UTF8> {
  ...
  public void set(String string) {
    if (string.length() > 0xffff/3) {             // maybe too long
      ...
      LOG.truncating_long_string_chars_starting_wi(String.valueOf(string.length()), String.valueOf(string.substring(0,20))).tag("methodCall").warn();
  ...
  public static int writeString(DataOutput out, String s) throws IOException {
    if (s.length() > 0xffff/3) {         // maybe too long
      ...
      LOG.truncating_long_string_chars_starting_wi(String.valueOf(s.length()), String.valueOf(s.substring(0,20))).tag("methodCall").warn();
