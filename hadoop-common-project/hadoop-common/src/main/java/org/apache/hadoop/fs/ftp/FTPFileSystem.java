...
public class FTPFileSystem extends FileSystem {
  ...
  public static final /* LogLOG=LogFactory.getLog(FTPFileSystem.class); */
  ...
  private void disconnect(FTPClient client) throws IOException {
    if (client != null) {
      ...
      if (!logoutSuccess) {
        ...
        LOG.logout_failed_while_disconnecting_error_(String.valueOf(client.getReplyCode())).tag("methodCall").warn();
      }
    }
  }
