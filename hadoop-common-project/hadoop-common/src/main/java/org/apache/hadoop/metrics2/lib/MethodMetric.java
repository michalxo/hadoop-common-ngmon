...
class MethodMetric extends MutableMetric {
  private static final /* LogLOG=LogFactory.getLog(MethodMetric.class); */
      ...
      return new MutableMetric() {
        @Override public void snapshot(MetricsRecordBuilder rb, boolean all) {
          try {
            ...
            LOG.error_invoking_method(String.valueOf(method.getName()), ex.toString()).tag("methodCall").error();
          }
        }
      };
    }
