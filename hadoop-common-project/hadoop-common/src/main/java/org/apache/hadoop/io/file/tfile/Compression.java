...
final class Compression {
  static final /* LogLOG=LogFactory.getLog(Compression.class); */
      ...
      public synchronized boolean isSupported() {
        if (!checked) {
          ...
          try {
            ...
            LOG.trying_load_lzo_codec_class(clazz).info();
            codec =
      ...
      if (codec != null) {
        ...
        if (compressor != null) {
          if (compressor.finished()) {
            ...
            LOG.compressor_obtained_from_codecpool_alrea().warn();
          } else {
            if(LogGlobal.isDebugEnabled()) {
              /* LOG.debug("Got a compressor: "+compressor.hashCode()) */
              LOG.got_compressor(String.valueOf(compressor.hashCode())).tag("methodCall").debug();
            }
          }
          /**
    ...
    public void returnCompressor(Compressor compressor) {
      if (compressor != null) {
        if(LogGlobal.isDebugEnabled()) {
          ...
          LOG.return_compressor(String.valueOf(compressor.hashCode())).tag("methodCall").debug();
        }
      ...
      if (codec != null) {
        ...
        if (decompressor != null) {
          if (decompressor.finished()) {
            ...
            LOG.deompressor_obtained_from_codecpool_alre().warn();
          } else {
            if(LogGlobal.isDebugEnabled()) {
              /* LOG.debug("Got a decompressor: "+decompressor.hashCode()) */
              LOG.got_decompressor(String.valueOf(decompressor.hashCode())).tag("methodCall").debug();
            }
          }
          /**
           * Following statement is necessary to get around bugs in 0.18 where a
    ...
    public void returnDecompressor(Decompressor decompressor) {
      if (decompressor != null) {
        if(LogGlobal.isDebugEnabled()) {
          ...
          LOG.returned_decompressor(String.valueOf(decompressor.hashCode())).tag("methodCall").debug();
        }
