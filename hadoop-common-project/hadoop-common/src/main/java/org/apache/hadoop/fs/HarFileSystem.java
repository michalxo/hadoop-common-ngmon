...
public class HarFileSystem extends FileSystem {
  ...
  private static final /* LogLOG=LogFactory.getLog(HarFileSystem.class); */
  ...
  private class HarMetaData {
    ...
    private void parseMetaData() throws IOException {
      ...
      try {
        ...
        LOG.encountered_exception(ioe.toString()).warn();
        throw ioe;
      } finally {
        IOUtils.cleanup(null, lin, in);
      }
