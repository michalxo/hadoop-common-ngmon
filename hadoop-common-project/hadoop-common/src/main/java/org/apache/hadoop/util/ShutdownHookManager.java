...
public class ShutdownHookManager {
  ...
  private static final /* LogLOG=LogFactory.getLog(ShutdownHookManager.class); */
        ...
        public void run() {
          ...
          for (Runnable hook: MGR.getShutdownHooksInOrder()) {
            try {
              ...
              LOG.shutdownhook_failed(String.valueOf(hook.getClass().getSimpleName()), String.valueOf(ex.toString()), ex.toString()).tag("methodCall").warn();
            }
          }
        }
      }
