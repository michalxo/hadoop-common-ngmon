...
public class NativeIO {
  public static class POSIX {
    ...
    private static final /* LogLOG=LogFactory.getLog(NativeIO.class); */
    ...
    static {
      if (NativeCodeLoader.isNativeCodeLoaded()) {
        try {
          ...
          LOG.initialized_cache_for_ids_user_group_cac(cacheTimeout/1000).tag("mathExp").debug();
          ...
          LOG.unable_initialize_nativeio_libraries(t.toString()).error();
        }
      }
    }
      ...
      if (!Shell.WINDOWS) {
        ...
        try {
          ...
          if (nioe.getErrorCode() == 3) {
            ...
            LOG.nativeio_chmod_error(String.valueOf(nioe.getErrorCode()), String.valueOf(nioe.getMessage())).tag("methodCall").warn();
      ...
      if (!Shell.WINDOWS) {
        ...
        try {
          ...
          if (nioe.getErrorCode() == 6) {
            ...
            LOG.nativeio_getfstat_error(String.valueOf(nioe.getErrorCode()), String.valueOf(nioe.getMessage())).tag("methodCall").warn();
            throw new NativeIOException("Unknown error", Errno.UNKNOWN);
          }
        }
      }
    ...
    private static String getName(IdCache domain, int id) throws IOException {
      ...
      if (cachedName != null && (cachedName.timestamp + cacheTimeout) > now) {
        ...
        if (LogGlobal.isDebugEnabled()) {
          ...
          LOG.got_for_from_native_implementation(type, name, id).debug();
        }
  ...
  static long getOperatingSystemPageSize() {
    try {
      ...
      LOG.unable_get_operating_system_page_size(e.toString()).warn();
      return 4096;
    }
  }
  ...
  public static String getOwner(FileDescriptor fd) throws IOException {
    ...
    if (Shell.WINDOWS) {
      ...
      LOG.got_username_for_uid_from_native(user, uid).info();
  ...
  private synchronized static void ensureInitialized() {
    if (!initialized) {
      ...
      LOG.initialized_cache_for_uid_user_mapping_t(cacheTimeout/1000).tag("mathExp").info();
      initialized = true;
    }
  }
