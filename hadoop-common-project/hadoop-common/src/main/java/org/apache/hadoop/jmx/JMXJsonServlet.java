...
import log_events.org.apache.hadoop.JmxNamespace;
...
public class JMXJsonServlet extends HttpServlet {
  private static final /* LogLOG=LogFactory.getLog(JMXJsonServlet.class); */
			JmxNamespace LOG = LoggerFactory.getLogger(JmxNamespace.class, new SimpleLogger());
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) {
    try {
      ...
      LOG.caught_exception_while_processing_jmx_re(e.toString()).error();
  ...
  throws IOException {
    ...
    LOG.listing_beans_for(qry.toString()).debug();
    ...
    while (it.hasNext()) {
      ...
      try {
        ...
        try {
          ...
          LOG.getting_attribute_threw_exception(prs, oname.toString(), e.toString()).error();
        ...
        LOG.problem_while_trying_process_jmx_query_w(qry.toString(), oname.toString(), e.toString()).error();
        continue;
      } catch ( ReflectionException e ) {
  ...
  private void writeAttribute(JsonGenerator jg, ObjectName oname, MBeanAttributeInfo attr) throws IOException {
    ...
    try {
      ...
      if (e.getCause() instanceof UnsupportedOperationException) {
        ...
        LOG.getting_attribute_threw_exception(attName, oname.toString(), e.toString()).debug();
      } else {
        /* LOG.error("getting attribute "+attName+" of "+oname+" threw an exception",e) */
        LOG.getting_attribute_threw_exception(attName, oname.toString(), e.toString()).error();
      }
      return;
