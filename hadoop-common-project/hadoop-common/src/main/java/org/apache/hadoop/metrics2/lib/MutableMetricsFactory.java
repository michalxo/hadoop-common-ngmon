...
public class MutableMetricsFactory {
  private static final /* LogLOG=LogFactory.getLog(MutableMetricsFactory.class); */
  ...
  MutableMetric newForField(Field field, Metric annotation,
    ...
    if (LogGlobal.isDebugEnabled()) {
      ...
      LOG.field_with_annotation(field.toString(), annotation.toString()).debug();
    }
  ...
  MutableMetric newForMethod(Object source, Method method, Metric annotation,
    ...
    if (LogGlobal.isDebugEnabled()) {
      ...
      LOG.method_with_annotation(method.toString(), annotation.toString()).debug();
    }
