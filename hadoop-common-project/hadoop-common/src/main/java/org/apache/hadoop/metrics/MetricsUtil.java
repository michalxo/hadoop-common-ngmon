...
public class MetricsUtil {
  ...
  public static final /* LogLOG=LogFactory.getLog(MetricsUtil.class); */
  ...
  public static MetricsContext getContext(String refName, String contextName) {
    ...
    try {
      ...
      LOG.unable_create_metrics_context(contextName, ex.toString()).error();
  ...
  private static String getHostName() {
    ...
    try {
      ...
      LOG.unable_obtain_hostname(ex.toString()).info();
      hostName = "unknown";
    }
    return hostName;
  }
