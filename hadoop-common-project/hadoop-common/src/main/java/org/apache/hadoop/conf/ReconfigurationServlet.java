...
public class ReconfigurationServlet extends HttpServlet {
  ...
  private static final long serialVersionUID = 1L;
    ...
    private static final ConfNamespace LOG = LoggerFactory.getLogger(ConfNamespace.class, new SimpleLogger());
//    LogFactory.getLog(ReconfigurationServlet.class);
  ...
  private Reconfigurable getReconfigurable(HttpServletRequest req) {
    ...
    LOG.servlet_path(String.valueOf(req.getServletPath())).tag("methodCall").info();
    /* LOG.info("getting attribute: "+CONF_SERVLET_RECONFIGURABLE_PREFIX+req.getServletPath()) */
    LOG.getting_attribute(CONF_SERVLET_RECONFIGURABLE_PREFIX, String.valueOf(req.getServletPath())).tag("methodCall").info();
        ...
        if (value != null) {
          if (value.equals(newConf.getRaw(param)) || value.equals("default") ||
            ...
            if ((value.equals("default") || value.equals("null") || 
              ...
              LOG.property_unchanged(param).info();
            }
          } else {
