...
public class ProtobufRpcEngine implements RpcEngine {
  public static final /* LogLOG=LogFactory.getLog(ProtobufRpcEngine.class); */
  ...
  private static class Invoker implements RpcInvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args)
      ...
      if (LogGlobal.isTraceEnabled()) {
        ...
        LOG.call(String.valueOf(Thread.currentThread().getId()), remoteId.toString(), String.valueOf(method.getName()), String.valueOf(TextFormat.shortDebugString((Message)args[1]))).tag("methodCall").trace();
      }
      ...
      try {
        ...
        if (LogGlobal.isTraceEnabled()) {
          ...
          LOG.exception(String.valueOf(Thread.currentThread().getId()), remoteId.toString(), String.valueOf(method.getName()), e.toString()).tag("methodCall").trace();
        }
      ...
      if (LogGlobal.isDebugEnabled()) {
        ...
        LOG.call_took(String.valueOf(method.getName()), callTime).tag("methodCall").debug();
      }
      ...
      try {
        ...
        if (LogGlobal.isTraceEnabled()) {
          ...
          LOG.response(String.valueOf(Thread.currentThread().getId()), remoteId.toString(), String.valueOf(method.getName()), String.valueOf(TextFormat.shortDebugString(returnMessage))).tag("methodCall").trace();
        }
  ...
  public static class Server extends RPC.Server {
    ...
    static class ProtoBufRpcInvoker implements RpcInvoker {
      ...
      public Writable call(RPC.Server server, String connectionProtocolName,
        ...
        if (server.verbose)
          /* LOG.info("Call: connectionProtocolName="+connectionProtocolName+", method="+methodName) */
          LOG.call_connectionprotocolname_method(connectionProtocolName, methodName).info();
        ...
        try {
          ...
          if (LogGlobal.isDebugEnabled()) {
            ...
            LOG.served_queuetime_procesingtime(methodName, qTime, processingTime).info();
          }
