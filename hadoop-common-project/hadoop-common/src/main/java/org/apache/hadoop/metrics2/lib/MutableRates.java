...
public class MutableRates extends MutableMetric {
  static final /* LogLOG=LogFactory.getLog(MutableRates.class); */
  ...
  public void init(Class<?> protocol) {
    ...
    for (Method method : protocol.getDeclaredMethods()) {
      ...
      try { registry.newRate(name, name, false, true); }
        ...
        LOG.error_creating_rate_metrics_for(String.valueOf(method.getName()), e.toString()).tag("methodCall").error();
      }
    }
  }
