...
public class ServiceAuthorizationManager {
  ...
  public static final /* LogAUDITLOG=LogFactory.getLog("SecurityLogger."+ServiceAuthorizationManager.class.getName()); */
  ...
  public void authorize(UserGroupInformation user, 
    ...
    if((clientPrincipal != null && !clientPrincipal.equals(user.getUserName())) || 
      ...
      LOG.for_protocol_expected_client_kerberos_pr(AUTHZ_FAILED_FOR, user.toString(), protocol.toString(), clientPrincipal).warn();
      throw new AuthorizationException("User " + user + 
          " is not authorized for protocol " + protocol + 
          ", expected client Kerberos principal is " + clientPrincipal);
    }
    /* AUDITLOG.info(AUTHZ_SUCCESSFUL_FOR+user+" for protocol="+protocol) */
    LOG.for_protocol(AUTHZ_SUCCESSFUL_FOR, user.toString(), protocol.toString()).info();
  }
