...
public class Lz4Compressor implements Compressor {
  private static final /* LogLOG=LogFactory.getLog(Lz4Compressor.class.getName()); */
  ...
  static {
    if (NativeCodeLoader.isNativeCodeLoaded()) {
      ...
      try {
        ...
        /* LOG.warn(t.toString()) */
        LOG.tmethodcall(String.valueOf(t.toString())).tag("methodCall").warn();
      }
    } else {
      /* LOG.error("Cannot load "+Lz4Compressor.class.getName()+" without native hadoop library!") */
      LOG.cannot_load_without_native_hadoop_librar(String.valueOf(Lz4Compressor.class.getName())).tag("methodCall").error();
    }
  }
