...
public class RetryCache {
  public static final /* LogLOG=LogFactory.getLog(RetryCache.class); */
    ...
    try {
      ...
      if (mapEntry == null) {
        if (LogGlobal.isTraceEnabled()) {
          ...
          LOG.adding_rpc_request_clientid_callid_retry(String.valueOf(newEntry.clientIdMsb), String.valueOf(newEntry.clientIdLsb), String.valueOf(newEntry.callId)).tag("methodCall").trace();
        }
        set.put(newEntry);
