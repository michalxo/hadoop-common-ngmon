...
public class ZlibFactory {
  private static final /* LogLOG=LogFactory.getLog(ZlibFactory.class); */
  ...
  static {
    if (NativeCodeLoader.isNativeCodeLoaded()) {
      ...
      if (nativeZlibLoaded) {
        ...
        LOG.successfully_loaded_initialized_native_z().info();
      } else {
        /* LOG.warn("Failed to load/initialize native-zlib library") */
        LOG.failed_load_initialize_native_zlib_libra().warn();
      }
    }
  }
