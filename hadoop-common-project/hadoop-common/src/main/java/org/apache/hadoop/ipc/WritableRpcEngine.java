...
//  private static final Log LOG = LogFactory.getLog(RPC.class);
  private static final IpcNamespace LOG = LoggerFactory.getLogger(IpcNamespace.class, new SimpleLogger());
  ...
  private static class Invoker implements RpcInvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args)
      ...
      if (LogGlobal.isDebugEnabled()) {
        ...
        LOG.call(String.valueOf(method.getName()), callTime).tag("methodCall").debug();
      }
      return value.get();
    }
      ...
      public Writable call(org.apache.hadoop.ipc.RPC.Server server,
       ...
       try {
          ...
          if (LogGlobal.isDebugEnabled()) {
            ...
            LOG.served_queuetime_procesingtime(String.valueOf(call.getMethodName()), qTime, processingTime).tag("methodCall").debug();
          }
          ...
          if (!(e instanceof IOException)) {
            ...
            LOG.unexpected_throwable_object(e.toString()).error();
          }
