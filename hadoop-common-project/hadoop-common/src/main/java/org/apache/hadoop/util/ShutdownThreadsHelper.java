...
public class ShutdownThreadsHelper {
  private static /* LogLOG=LogFactory.getLog(ShutdownThreadsHelper.class); */
  ...
  public static boolean shutdownThread(Thread thread,
    ...
    try {
      ...
      LOG.interrupted_while_shutting_down_thread(String.valueOf(thread.getName())).tag("methodCall").warn();
      return false;
    }
  }
