...
public class Token<T extends TokenIdentifier> implements Writable {
  public static final /* LogLOG=LogFactory.getLog(Token.class); */
  ...
  private static Class<? extends TokenIdentifier>
    ...
    if (cls == null) {
      ...
      LOG.cannot_find_class_for_token_kind(kind.toString()).warn();
      return null;
    }
    return cls;
  }
  ...
  private synchronized TokenRenewer getRenewer() throws IOException {
    ...
    LOG.tokenrenewer_defined_for_token_kind(String.valueOf(this.kind)).tag("methodCall").warn();
    return renewer;
  }
