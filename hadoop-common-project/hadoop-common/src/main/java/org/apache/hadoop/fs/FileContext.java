...
public final class FileContext {
  ...
  public static final /* LogLOG=LogFactory.getLog(FileContext.class); */
  ...
  private FileContext(final AbstractFileSystem defFs,
    ...
    try {
      ...
      LOG.exception_getcurrentuser(e.toString()).error();
      ...
      for (Entry<FileContext, Set<Path>> entry : set) {
        ...
        for (Path path : paths) {
          try {
            ...
            LOG.ignoring_failure_deleteonexit_for_path(path.toString()).warn();
          }
        }
      }
  ...
  private static AbstractFileSystem getAbstractFileSystem(
    ...
    try {
      ...
      /* LOG.error(ex) */
      LOG.exception(ex.toString()).error();
