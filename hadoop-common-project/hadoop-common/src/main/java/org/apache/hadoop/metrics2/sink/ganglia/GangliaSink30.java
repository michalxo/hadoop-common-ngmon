...
public class GangliaSink30 extends AbstractGangliaSink {
  ...
  public final /* LogLOG=LogFactory.getLog(this.getClass()); */
  ...
  protected void emitMetric(String groupName, String name, String type,
    ...
    if (LogGlobal.isDebugEnabled()) {
      ...
      LOG.emitting_metric_type_value_slope_from(name, type, value, String.valueOf(gSlope.name()), getHostName()).tag("methodCall").debug();
    }
