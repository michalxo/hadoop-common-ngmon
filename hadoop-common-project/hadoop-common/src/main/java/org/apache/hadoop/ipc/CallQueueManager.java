...
public class CallQueueManager<E> {
  public static final /* LogLOG=LogFactory.getLog(CallQueueManager.class); */
  ...
  public CallQueueManager(Class<? extends BlockingQueue<E>> backingClass,
    ...
    LOG.using_callqueue(backingClass.toString()).info();
  }
  ...
  public synchronized void swapQueue(
    ...
    LOG.old_queue_replacement(stringRepr(oldQ), stringRepr(newQ)).tag("methodCall").info();
  }
