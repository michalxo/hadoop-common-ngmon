...
public class GenericOptionsParser {
  ...
  private static final /* LogLOG=LogFactory.getLog(GenericOptionsParser.class); */
  ...
  private void processGeneralOptions(Configuration conf,
    ...
    if(line.hasOption("tokenCacheFile")) {
      ...
      if(LogGlobal.isDebugEnabled()) {
        ...
        LOG.setting_conf_tokensfile(fileName).debug();
      }
  ...
  public static URL[] getLibJars(Configuration conf) throws IOException {
    ...
    for (String file : files) {
      ...
      if (tmp.getFileSystem(conf).equals(FileSystem.getLocal(conf))) {
        ...
        LOG.libjars_file_not_local_filesystem_ignori(tmp.toString()).warn();
      }
    }
  ...
  private void parseGeneralOptions(Options opts, Configuration conf, 
    ...
    try {
      ...
      LOG.options_parsing_failed(String.valueOf(e.getMessage())).tag("methodCall").warn();
