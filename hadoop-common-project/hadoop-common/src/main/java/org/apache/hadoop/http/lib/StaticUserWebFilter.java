...
public class StaticUserWebFilter extends FilterInitializer {
  ...
  private static final /* LogLOG=LogFactory.getLog(StaticUserWebFilter.class); */
  ...
  static String getUsernameFromConf(Configuration conf) {
    ...
    if (oldStyleUgi != null) {
      ...
      LOG.should_not_used_instead_use(DEPRECATED_UGI_KEY, HADOOP_HTTP_STATIC_USER).warn();
