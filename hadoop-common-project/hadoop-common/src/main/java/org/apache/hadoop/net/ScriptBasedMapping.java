...
public final class ScriptBasedMapping extends CachedDNSToSwitchMapping {
  ...
  private static final class RawScriptBasedMapping
    ...
    private static final /* LogLOG=LogFactory.getLog(ScriptBasedMapping.class); */
    ...
    public List<String> resolve(List<String> names) {
      ...
      if (output != null) {
        ...
        if (m.size() != names.size()) {
          ...
          /* LOG.error("Script "+scriptName+" returned "+Integer.toString(m.size())+" values when "+Integer.toString(names.size())+" were expected.") */
          LOG.script_returned_values_when_were_expecte(scriptName, String.valueOf(Integer.toString(m.size())), String.valueOf(Integer.toString(names.size()))).tag("methodCall").error();
          return null;
        }
      } else {
    ...
    private String runResolveCommand(List<String> args) {
      ...
      if (maxArgs < MIN_ALLOWABLE_ARGS) {
        ...
        LOG.invalid_value_for_must(String.valueOf(Integer.toString(maxArgs)), SCRIPT_ARG_COUNT_KEY, String.valueOf(Integer.toString(MIN_ALLOWABLE_ARGS))).tag("methodCall").warn();
        return null;
      }
      ...
      while (numProcessed != args.size()) {
        ...
        try {
          ...
          LOG.exception_running(s.toString(), e.toString()).warn();
          return null;
        }
        loopCount++;
      }
