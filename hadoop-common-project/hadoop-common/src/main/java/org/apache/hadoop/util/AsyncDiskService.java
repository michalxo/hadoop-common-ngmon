...
public class AsyncDiskService {
  ...
  public static final /* LogLOG=LogFactory.getLog(AsyncDiskService.class); */
  ...
  public synchronized void shutdown() {
    ...
    LOG.shutting_down_all_asyncdiskservice_threa().info();
  ...
  public synchronized boolean awaitTermination(long milliseconds) 
    ...
    for (Map.Entry<String, ThreadPoolExecutor> e:
      ...
      if (!executor.awaitTermination(
        ...
        LOG.asyncdiskservice_awaittermination_timeou().warn();
        return false;
      }
    }
    /* LOG.info("All AsyncDiskService threads are terminated.") */
    LOG.all_asyncdiskservice_threads_are_termina().info();
    return true;
  }
