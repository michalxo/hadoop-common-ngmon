...
public class NetUtils {
  private static final /* LogLOG=LogFactory.getLog(NetUtils.class); */
  ...
  public static void connect(Socket socket, 
    ...
    if (socket.getLocalPort() == socket.getPort() &&
      ...
      LOG.detected_loopback_tcp_socket_disconnecti().info();
      socket.close();
  ...
  private static <T extends IOException> T wrapWithMessage(
    ...
    try {
      ...
      LOG.unable_wrap_exception_type_has_string(clazz.toString(), e.toString()).warn();
      return exception;
    }
  }
  ...
  public static List<InetAddress> getIPs(String subnet,
    ...
    try {
      ...
      LOG.unable_get_host_interfaces(e.toString()).error();
      return addrs;
    }
