...
public class HAServiceProtocolServerSideTranslatorPB implements
  ...
  private static final /* LogLOG=LogFactory.getLog(HAServiceProtocolServerSideTranslatorPB.class); */
  ...
  private StateChangeRequestInfo convert(HAStateChangeRequestInfoProto proto) {
    ...
    default:
      ...
      LOG.unknown_request_source(String.valueOf(proto.getReqSource())).tag("methodCall").warn();
      src = null;
    }
