...
public class DNS {
  ...
  private static final /* LogLOG=LogFactory.getLog(DNS.class); */
  ...
  public static String[] getIPs(String strInterface,
    ...
    try {
      ...
      LOG.error_finding_interface(strInterface, String.valueOf(e.getMessage())).tag("methodCall").warn();
      return new String[] { cachedHostAddress };
    }
    if (netIf == null) {
  ...
  public static String[] getHosts(String strInterface, String nameserver)
    ...
    if (hosts.isEmpty()) {
      ...
      LOG.unable_determine_hostname_for_interface(strInterface).warn();
  ...
  private static String resolveLocalHostname() {
    ...
    try {
      ...
      LOG.unable_determine_local_hostname_falling_(LOCALHOST, e.toString()).warn();
      localhost = LOCALHOST;
    }
    return localhost;
  }
  ...
  private static String resolveLocalHostIPAddress() {
    String address;
      try {
        ...
        LOG.unable_determine_address_host_falling_ba(LOCALHOST, e.toString()).warn();
        try {
          ...
          LOG.unable_determine_local_loopback_address_(LOCALHOST, e.toString()).error();
          address = null;
        }
      }
    return address;
