...
public class SerializationFactory extends Configured {
  ...
  static final /* LogLOG=LogFactory.getLog(SerializationFactory.class.getName()); */
  ...
  public SerializationFactory(Configuration conf) {
    ...
    if (conf.get(CommonConfigurationKeys.IO_SERIALIZATIONS_KEY).equals("")) {
      ...
      LOG.serialization_for_various_data_types_may(String.valueOf(CommonConfigurationKeys.IO_SERIALIZATIONS_KEY)).tag("methodCall").warn();
    } else {
  ...
  private void add(Configuration conf, String serializationName) {
    try {
      ...
      LOG.serialization_class_not_found(e.toString()).warn();
    }
  }
