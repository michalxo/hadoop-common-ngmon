...
public final class RpcUtil {
  ...
  static class RpcFrameDecoder extends FrameDecoder {
    public static final /* LogLOG=LogFactory.getLog(RpcFrameDecoder.class); */
  ...
  static final class RpcMessageParserStage extends SimpleChannelUpstreamHandler {
    private static final /* LogLOG=LogFactory.getLog(RpcMessageParserStage.class); */
			OncrpcNamespace LOG = LoggerFactory.getLogger(OncrpcNamespace.class, new SimpleLogger());
    ...
    public void messageReceived(ChannelHandlerContext ctx, MessageEvent e)
      ...
      try {
        ...
        LOG.malfromed_rpc_request_from(String.valueOf(e.getRemoteAddress())).tag("methodCall").info();
      }
