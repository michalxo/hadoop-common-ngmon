...
public class SimpleTcpServer {
  public static final /* LogLOG=LogFactory.getLog(SimpleTcpServer.class); */
  ...
  public void run() {
    ...
    LOG.started_listening_tcp_requests_port_for_(boundPort, rpcProgram.toString(), workerCount).info();
  }
