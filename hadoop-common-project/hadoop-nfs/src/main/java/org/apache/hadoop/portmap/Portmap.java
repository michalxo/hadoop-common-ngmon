 ...
 */
final class Portmap {
  private static final /* LogLOG=LogFactory.getLog(Portmap.class); */
  ...
  public static void main(String[] args) {
    StringUtils.startupShutdownMessage(Portmap.class, args, LogFactory.getLog(Portmap.class));
    ...
    try {
      ...
      LOG.failed_start_server_cause(e.toString()).fatal();
      pm.shutdown();
      System.exit(-1);
    }
  }
  ...
  void start(final int idleTimeMilliSeconds, final SocketAddress tcpAddress,
    ...
    LOG.portmap_server_started_tcp_udp(String.valueOf(tcpChannel.getLocalAddress()), String.valueOf(udpChannel.getLocalAddress())).tag("methodCall").info();
  }
}
