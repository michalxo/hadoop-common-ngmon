...
public class AuthenticationFilter implements Filter {
  ...
  private static /* LoggerLOG=LoggerFactory.getLogger(AuthenticationFilter.class); */
  ...
  public void init(FilterConfig filterConfig) throws ServletException {
    ...
    if (signatureSecret == null) {
      ...
      LOG.signature_secret_configuration_not_set_u().warn();
    }
  ...
  public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain)
    ...
    try {
      ...
      try {
        ...
        LOG.authenticationtoken_ignored(String.valueOf(ex.getMessage())).tag("methodCall").warn();
      ...
      if (authHandler.managementOperation(token, httpRequest, httpResponse)) {
        if (token == null) {
          if (LogGlobal.isDebugEnabled()) {
            ...
            LOG.request_triggering_authentication(httpRequest.toString()).debug();
          }
        ...
        if (token != null) {
          ...
          if (LogGlobal.isDebugEnabled()) {
            ...
            LOG.request_user_authenticated(httpRequest.toString(), String.valueOf(token.getUserName())).tag("methodCall").debug();
          }
      ...
      LOG.authentication_exception(String.valueOf(ex.getMessage()), ex.toString()).tag("methodCall").warn();
    }
